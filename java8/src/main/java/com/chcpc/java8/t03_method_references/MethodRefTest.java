 ...
 *  2.方法引用可以看做是Lambda表达式深层次的表达。换句话说，方法引用就是Lambda表达式，也是函数式接口的一个实例，
...
public class MethodRefTest {
    // 情况一：对象::实例方法
    // Consumer中的void accept(T t02_factional_interface)
    // PrintStream中的void println(T t02_factional_interface)
    @Test
    public void test1(){
    ...
    // Function中的 R apply(T t02_factional_interface)
    ...
    public void test5(){
        ...
        System.out.println(com2.compare("fff","sss"));
    ...
    @Test
    public void test7(){
        Employee employee = new Employee(1001, "Joy", 23, 4432);
